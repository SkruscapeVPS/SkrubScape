...
public class Config {
	 ...
	 * Your server name.
	 */
	public static final String SERVER_NAME = "SkrubScape";

	/**
	 * The welcome message displayed once logged in the server.
	 */
	public static final String WELCOME_MESSAGE = "SkrubScape";

	/**
	 * The current message of the day, displayed once a player has logged in.
	 */
	public static final String MOTD = "Welcome to SkrubScape!";

	/**
	 * A URL to your server forums. Not necessary needed.
	 */
	public static final String FORUMS = "http://skrubscape.forumotion.com/";
	 ...
	 */
	public static final int ITEM_LIMIT = 20432;
	 ...
	 */
	public static final int[] ITEM_TRADEABLE = { 9008, 15038, 9007, 2944, 10025, 13280, 11941, 12791, 13329, 13331, 13333,
	...
	public static final int[] ITEMS_KEPT_ON_DEATH = {
			...
			12785, 15038, 12954, 15573, 8135, 11864, 11865, 12432, 12389, 12373, 12379, 12369, 12367, 12365, 12363, 7449, 611,
			...
			13281, 7457, 7456, 7455, 7582, 15572, 12855, 12856, 13282, 13280, 13342, 13329, 13330, 13331, 13332, 13333, 13334, 13335, 13336, 13337, 13338,
	...
	public static final String[] UNSPAWNABLE = { "ahrim", "key", "bone shard", "twisted bow", " uncut onyx", "torva", "death cape", "fallen angel", "reindeer", "perfect", "token", "lamp", "korasi", "warrior guild", "manta",
	...
	public static final int START_LOCATION_Y = 3483;

	/**
	 * The re-spawn point of when someone dies.
	 */
	public static final int RESPAWN_X = 3165;
	public static final int RESPAWN_Y = 3483;
	 ...
	 */
	public static final int MELEE_EXP_RATE = 16;
	public static final int RANGE_EXP_RATE = 16;
	public static final int MAGIC_EXP_RATE = 16;

	/**
	 * Special server experience bonus rates. (Double experience weekend etc)
	 */

	public static final double SERVER_EXP_BONUS = 10;

	/**
	 * XP given when XP is boosted by a voting reward only
	 */
	public static final double SERVER_EXP_BONUS_BOOSTED = 5;
	/**
	 * XP given when XP is boosted by a voting reward and bonus mode
	 */
	public static final double SERVER_EXP_BONUS_WEEKEND_BOOSTED = 8;
	...
	public static final Boundary GE_PK_BOUNDARY = new Boundary(3159, 3450, 3173, 3465);
	/**
	 ...
	 */
	public static final int SAVE_TIMER = 60; // Saves every 30 secs.
	...
	public static final int MINING_EXPERIENCE = 150;
	...
	public static final int AGILITY_EXPERIENCE = 125;
	...
	public static final int SLAYER_EXPERIENCE = 25;
	public static final int COOKING_EXPERIENCE = 20;
	public static final int FLETCHING_EXPERIENCE = 25;
