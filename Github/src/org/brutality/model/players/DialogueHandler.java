...
/*		if (c.dialogue().isActive()) {
		 ...
		 */
		case 1610:
			sendNpcChat2("Hello " + c.playerName + ", and welcome to Noxious ,", "Would you like to take the tutorial again?", 306, "Otto godblessed");
			c.nextChat = 1611;
		break;
		case 1611:
			sendOption2("Yes.", "No, sorry not right now!");
			...
			break;
	case 1600:
		sendNpcChat3("Hello " + c.playerName + ", and welcome to Noxious ,", "I'll quickly give you a few brief tips",
					 "in order to better your stay here at Noxious .", 306, "Noxious  Guide");
		c.nextChat = 1602;
	break;
	case 1602:
		sendNpcChat3("We have 2 home areas,", "one in zeah and the other in edgeville.", 
					 "Use which ever you like for your convenience.", 306, "Noxious  Guide");
	...
	case 6670:
		...
		break;
	case 1603:
		sendNpcChat2("This is our home, here you can find shops,", "banks, slayer masters, and everything else you would need!", 306, "Noxious  Guide");
		c.nextChat = 1604;
	break;
	case 1604:
		sendNpcChat3("This is the skilling area", "where you can get your skills up and earn pk points", 
					 "you can even get skilling pets if you're lucky.", 306, "Noxious Guide");
		c.getPA().movePlayer(1803, 3788, 0);
		c.nextChat = 1605;
	break;
	case 1605:
		sendNpcChat2("We have a huge array of interesting bosses,", "which includes full Cerberus and Abyssal sire", 306, "Noxious Guide");
		c.getPA().movePlayer(1240, 1245, 0);
		c.nextChat = 1606;
	break;
	case 1606:
		sendNpcChat2("PK Points is our currency of choice,", "and its obtainable via bossing,skilling,and pking.", 306, "Noxious Guide");
		c.nextChat = 1607;
	break;
	case 1607:
		sendNpcChat3("The most creative aspect of our server is", "the new hunger games minigame that we",
					 "spent countless hours creating.", 306, "Noxious Guide");
	...
	break;
		...
		case 4007:
			sendOption3(
					"Redeem for 5000 PK Points.",
					"Redeem for 20,000 Donator points.",
					"No. I don't wanna use this.");
